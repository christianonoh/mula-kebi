  ...
  return (
    ...
    >
      <div className="flex items-center justify-between w-full ">
        ...
        <Link href='/categories/all' className="px-4 py-2 text-sm font-semibold capitalize rounded-full sm:text-base md:text-lg whitespace-nowrap hover:text-dark text-accent bg-accent/10 dark:hover:text-light dark:text-accentDark dark:bg-accentDark/10">
          view all
        </Link>
      </div>
